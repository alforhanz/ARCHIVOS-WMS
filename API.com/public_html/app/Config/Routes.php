...
// $routes->get('wmsverificacionpedidos/(:any)', 'WMSgetVerificacionPedidos::show/$1'); //Establece la ruta al controlador GetVerificacion
...
// $routes->get('wmsguardadopedidos/(:any)', 'WMSgetGuardadoParcialPedidos::show/$1');//Establece la ruta al controlador para Guardado Parcial,  Procesar Pedidos y actualizar filas eliminadas
...
//PICKIN NORWING
$routes->get('wmsguardadopicking/(:any)', 'WMSgetGuardadoParcialPicking::show/$1');//Establece la ruta al controlador para Guardado Parcial,  Procesar Pedidos y actualizar filas eliminadas
...
// $routes->get('wmsautorizacioncontenedor', 'WMSgetTrasladoAutorizacion::show');//Establece la ruta al controlador de las existencias de los articulos por bodega
// $routes->get('wmsordenesdecompras/(:any)', 'WMSordenesDeCompras::show_OrdenesDeCompras/$1');//Establece la ruta al controlador que trae la lista de las ordenes de compras
// $routes->get('wmsordenesdecompraslist', 'WMSordenesDeCompras::show_OrdenDeComprasList');//Establece la ruta al controlador que trae el detallado de una ordenes de compra especifica
// $routes->get('wmsguardaprocesaordendecompralist/(:any)', 'WMSguardaOdenesDeCompras::show/$1');//Establece la ruta al controlador que guarda parciálmente la lista de las ordenes de compras
// $routes->get('wmsinsertacodigobarra', 'WMSinsertaCodigoDeBarra::insertaCodigo');//Establece la ruta al controlador que inserta los nuevos codigos de barra
