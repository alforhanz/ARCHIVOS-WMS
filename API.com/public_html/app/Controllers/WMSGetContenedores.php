    ...
    public function buscaContenedores()
    	{
            ...
            if($pOpcion){
				...
				switch ($pOpcion) {					
					...
					case 'E':
							//$contenedor = $model->spContenedores($pSistema, $pUsuario,'E', $pBodegaEnvia, $pBodegaSolicita, $pConsecutivo, $pEstado, $pFechaDesde, $pFechaHasta);
					...
					case 'G':
           					try {		
									...
									$contenedor = $model->spGuardaCont('WMS', $pUsuario, 'G', 'WMS_BC', $pConsecutivo, $jsonDetalles, $pEstado, $pBodegaEnvia, $pUsuarioAutorizacion);
									return $this->getResponse(
											[
											'msg'       => 'SUCCESS',
					...
					case 'P':
           					try {
									$contenedor = $model->spGuardaCont('WMS', $pUsuario, 'P', 'WMS_BC', $pConsecutivo, $jsonDetalles, $pEstado, $pBodegaEnvia,$pUsuarioAutorizacion);
									return $this->getResponse(
											[
											'msg'       => 'SUCCESS',
...
// 					case 'A'://muestra los contenedores procesados
...
// 							  [
// 								  'msg'       => 'SUCCESS',
// 								  'message'   => 'contenedor Procesado recuperados con exito ',
// 								  'contenedor'   => $contenedor
// 							  ]
// 						  );
// 					break;
