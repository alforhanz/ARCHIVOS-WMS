     ...
     */
          public function create()
          {
            $model = new InsertarCliente_Model();
              ...
              if(!empty($input['ruta'])) {$rutas = $input["ruta"];}else {$rutas = null;}
              $alias = $razonSocial;
              $model = new InsertarCliente_Model();
			  $email = str_replace("", "", $email);
              $newcliente = $model->insertarcliente($tipoContribuyente, $nit, $razonSocial, $alias, $creado, $dv, $tipoClienteFE, $telefono, $sucursal, $fax, $email, $direccion, $notas, $nivelPrecio, $rutas);
