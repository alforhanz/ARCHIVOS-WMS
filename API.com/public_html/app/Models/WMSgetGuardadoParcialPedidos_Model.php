...
class WMSgetGuardadoParcialPedidos_Model extends Model
{
    //------------------------------------------------------------
    //  BUSQUEDA LISTA DE PEDIDOS
    //------------------------------------------------------------
//Guardado parcial del pedido
   public function sp_InsertUpdatePedido($pSistema=null,$pUsuario=null,$pOpcion=null,$pModulo=null,$pConsecutivoPed=null,$pBodega=null,$jsonDetalles=null,$pEstado=null)
    {
      try {
          $db = db_connect();
          ...
          $sql = "{CALL [CLSA].[WMS_sp_InsertUpdate_ControlEntrega] (?,?,?,?,?,?,?,?)}";
