...
class WMSgetGuardadoParcialPickingTraslado_Model extends Model
{
    //------------------------------------------------------------
    //  BUSQUEDA LISTA DE PEDIDOS
    //------------------------------------------------------------
//Guardado parcial del pedido
public function sp_InsertUpdatePicking($pSistema=null,$pUsuario=null,$pOpcion=null,$pModulo=null,$pConsecutivo=null,$pBodega=null,$jsonDetalles=null,$pEstado=null,$pTipoConsecutivo=null, $pBodegaDestino=null,$pAplicacion=null)
    {
      try {
            $db = db_connect();
            $params = array($pSistema, $pUsuario, $pOpcion, $pModulo, $pConsecutivo, $pBodega, $jsonDetalles, $pEstado,$pTipoConsecutivo,$pBodegaDestino,$pAplicacion);       
            // $sql = "{CALL [CLSA].[WMS_sp_InsertUpdate_ControlEntrega_Traslado] (?,?,?,?,?,?,?,?,?,?,?)}";
             $sql = "CLSA.WMS_sp_InsertUpdate_ControlEntrega_Traslado ?,?,?,?,?,?,?,?,?,?,?";
