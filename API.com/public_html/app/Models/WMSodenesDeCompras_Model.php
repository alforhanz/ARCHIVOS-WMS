...
class WMSodenesDeCompras_Model extends Model
{
   ...
   public function spGuardaOrdenCompraLectura($pSistema=null, $pUsuario=null, $pOpcion=null, $pModulo=null, $pConsecutivo=null, $jsonDetalles=null, $pEstado=null, $pBodega=null  )
    {
      try {
          $db = db_connect();          
          $params = array($pSistema, $pUsuario, $pOpcion, $pModulo, $pConsecutivo, $jsonDetalles, $pEstado, $pBodega);          
