...
use App\Models\WMSverificaCodigoDeBarra_Model;
use CodeIgniter\HTTP\ResponseInterface;
use Exception;

class WMSverificaCodigoDeBarra extends BaseController
{
	
    public function showCodigoBarra()
    {
        try {
                $model = new WMSverificaCodigoDeBarra_Model();
                ...
                $ordenCompra = $model->sp_getCodigoBarraArticulo($pCodigoBarra, $pArticulo);
