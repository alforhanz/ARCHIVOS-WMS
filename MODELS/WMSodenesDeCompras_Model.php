...
class WMSodenesDeCompras_Model extends Model
{
    //------------------------------------------------------------
    ...
    public function sp_getOrdenesdeCompras($pSistema, $pUsuario, $pOpcion,$pBodega,$pEstado, $pOrden)
    {
      ...
      //-------------------------------------------------------------//
     //       OBTIENE EL DETALLE DE UNA ORDEN DE COMPRAS            //
    //-------------------------------------------------------------//
   ...
   public function spGuardaOrdenCompraLectura($pSistema=null, $pUsuario=null, $pOpcion=null, $pModulo=null, $pConsecutivo=null, $jsonDetalles=null, $pEstado=null, $pBodega=null, $pObservacion=null  )
    {
      try {
          $db = db_connect();          
          $params = array($pSistema, $pUsuario, $pOpcion, $pModulo, $pConsecutivo, $jsonDetalles, $pEstado, $pBodega, $pObservacion);          
